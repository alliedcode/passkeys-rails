RSpec.describe MobilePass::PasskeysController do
  let(:call_api) { post '/mobile_pass/passkeys/refresh', params:, headers: }
  ...
  context 'with required params' do
    ...
    context 'with valid parameters and a successfull call to RefreshToken' do
      ...
      it 'Succeeds and reutrns instance credentails' do
        ...
        expect_success
        expect(MobilePass::RefreshToken).to have_received(:call!).exactly(1).time
