RSpec.describe MobilePass::PasskeysController do
  let(:call_api) { post '/mobile_pass/passkeys/authenticate', params:, headers: }
  ...
  context 'with required params' do
    ...
    context 'with valid parameters and a successfull call to FinishAuthentication' do
      ...
      it 'Succeeds and reutrns instance credentails' do
        allow(MobilePass::FinishAuthentication)
          .to receive(:call!)
        ...
        expect_success
        expect(MobilePass::FinishAuthentication).to have_received(:call!).exactly(1).time
