RSpec.describe Passkeys::Rails::PasskeysController do
  ...
  context 'with required params' do
    ...
    context 'with valid parameters and a successfull call to FinishAuthentication' do
      ...
      it 'Succeeds and reutrns instance credentails' do
        allow(Passkeys::Rails::FinishAuthentication)
          .to receive(:call!)
        ...
        expect_success
        expect(Passkeys::Rails::FinishAuthentication).to have_received(:call!).exactly(1).time
